...
public class AROCollectorTaskManagerDetailProcess implements Comparable<Object> {
     ...
     * @param runinfo An ActivityManager.RunningAppProcessInfo object that is used
     ...
     *
     * @param is A boolean value that indicates whether or not the task killer
     *           row is selected.
     */
     ...
     *
     * @param psrow An AROCollectorTaskManagerProcessInfo.PsRow object containing
     ...
     *
     * @param appinfo An ApplicationInfo object containing the new application
     *                information.
     */
     ...
     *
     * @param runinfo A RunningAppProcessInfo object containing the application
     ...
     *
     * @param pkg An AROCollectorTaskManagerPackagesInfo object to hold the
     ...
     *
     * @param pi An AROCollectorTaskManagerProcessInfo object to hold the Task
     ...
     *
     * @param value A Boolean value of "true" sets the row as the current
     *              application.
     */
