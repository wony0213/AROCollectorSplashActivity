...
public class ARODataCollector extends Application {
     ...
     *
     * @param videoRecording A boolean value that is "true" to enable video recording for a
     ...
     *
     * @param flag A boolean value that is "true" if the tcpdump is started, and
     *             "false" otherwise.
     */
     ...
     *
     * @param flag A boolean value that is true if the ARO Data Collector is in
     ...
     * the trace.
     *
     * @param flag A boolean value that is "true" if video capture is running
     ...
     *
     * @param paramElapsedTimeStartTime A long integer that represents when the trace started for the home page timer.
     */
     ...
     * mid-trace.
     *
     * @param flag A boolean value that is "true" if the SD card is mounted
     ...
     * mid-trace.
     *
     * @param flag A boolean value that is "true" if Airplane Mode was enabled
     *             during mid-trace, and "false" if it is not.
     */
     ...
     *
     * @param flag boolean value that is "true" if the video capture has failed,
     ...
     * changed.
     *
     * @param flag A boolean value that is "true" if the ARO Data Collector data
     ...
     *
     * @param flag A boolean value that is "true" if all listed tasks are
     ...
     * been issued.
     *
     * @param requestDataCollectorStop A boolean value that is true if a request
