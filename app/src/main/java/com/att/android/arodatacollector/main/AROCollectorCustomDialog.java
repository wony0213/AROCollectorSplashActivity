...
public class AROCollectorCustomDialog extends Dialog implements OnKeyListener {
     ...
     * @param type          The dialog type. One of the values of the
    ...
    public interface ReadyListener {
         ...
         *
         * @param errorcode The type of error dialog that handles the responses. One
         *                  of the types defined in the
         *                  AROCollectorCustomDialog.Dialog_CallBack_Error
         *                  enumeration.
         * @param success   A boolean value that indicates whether the error response
         *                  has been handled.
         */
    ...
    public interface DialogKeyListner {
         ...
         * @param type The type of dialog that the key events are being handled
